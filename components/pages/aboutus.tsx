        ...
        <div className="container w-[95%] bg-white shadow-2xl rounded-3xl p-12 h-full  flex items-center transition-transform hover:scale-[1.01] duration-300 ease-in-out">
          <section className="w-full flex flex-col md:flex-row items-center justify-between gap-12">
            ...
            <div className="w-full">
              ...
              <ul className="text-lg text-gray-700 mt-4 space-y-3 list-disc list-inside">
                {[
                  {
                    title: "Integrity",
                    description:
            ...
            <div className="hidden md:block w-full md:w-2/2">
              <img
                src="/aboutus.avif"
                alt="Our Team"
                className="w-full max-w-full mx-auto rounded-lg shadow-lg transition-transform hover:scale-105 duration-300"
              />
            </div>
          </section>
        </div>
